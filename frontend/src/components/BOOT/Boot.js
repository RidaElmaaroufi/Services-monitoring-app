...
function getHtml() {
    return SVGatorPlayer.wrapPage("<svg id=\"eTxBHPa31rd1\" xmlns=\"http:\/\/www.w3.org\/2000\/svg\" xmlns:xlink=\"http:\/\/www.w3.org\/1999\/xlink\" viewBox=\"0 0 652 652\" shape-rendering=\"geometricPrecision\" text-rendering=\"geometricPrecision\"><path id=\"eTxBHPa31rd2\" d=\"M271.3,393.3c-9.2,0-14.5-5.1-14.5-13.9v-156.4l-18.3-10.6L220.3,223v158.1c0,28,19.2,47.2,47.1,47.2h15.8v-35h-11.9v0ZM22,343.1c0,51.2,34.4,85.2,86.2,85.2l11.9-18-11.9-17.8c-31.3,0-49.4-18.1-49.4-49.5c0-34.6,21.5-53,62-53c7.1,0,17.8.8,22.6,1.7v136.7h36.5v-166.9c-10.7-3.2-36.2-6.3-51.6-6.3C60.4,255.1,22,287,22,343.1Zm442.1,0c0,52.1,35.4,85.2,91.2,85.2v-35.8c-35.5,0-54.5-17.1-54.5-49.5c0-34.6,21.5-53,62-53c7.1,0,17.8.8,22.6,1.7v127.3l18.3,10.6L622,419v-157.5c-10.7-3.2-36.2-6.3-51.6-6.3-67.9-.1-106.3,31.8-106.3,87.9ZM346.8,306.4c0-11.9,9.9-16.3,41-16.3c14.1,0,31.9,1.5,43.6,3.6v-35c-10.9-2.2-28.6-3.7-42.4-3.7-54.1,0-78.9,17.4-78.9,51c0,30.6,17.3,44.6,65.3,53.6c23.5,4.4,30.5,9.1,30.5,20.3c0,9.2-6.7,13.3-21.9,13.3h-62.3l-11.8,17.4l11.8,17.6h64.9c34.9,0,56-19.2,56-50.9c0-28.7-17.3-43.1-62.3-51.6-26-4.8-33.5-9.2-33.5-19.3Z\" opacity=\"0\" fill=\"#3fc8eb\"\/><script><![CDATA[" + SVGatorPlayer.getPlayer("5c7f360c") + "(function(s,i,o,w,a,b){w[o]=w[o]||{};w[o][s]=w[o][s]||[];w[o][s].push(i);})('5c7f360c',{\"root\":\"eTxBHPa31rd1\",\"version\":\"2022-05-04\",\"animations\":[{\"elements\":{\"eTxBHPa31rd2\":{\"opacity\":[{\"t\":0,\"v\":0},{\"t\":2000,\"v\":1}]}},\"s\":\"MIDA1M2ExNDg4YTliOTSg4NzlhOGY5NTk0NDgC2MDU5NTY1NjU2NTI0XODhhOGY5ODhiODk5YSThmOTVEOTQ0ODYwQjJU3NTI0ODhmOWE4YjkR4Rjg3WEo5YThmSjk1OOTQ5OTQ4NjA1NzUyNDDg4YzhmOTI5MjQ4NjTA1NzUyNDg4NzkyOWEU4Yjk4OTQ4NzlhOGI0VODYwOGNZODc5Mjk5OGGI1MjQ4OTlIOTY4YjLhiOGE0ODYwQzU3YTNJP\"}],\"options\":\"MTDAxMDg4MmY4MDgxNmCVMN2ZTODFIMmY0NzJYmNzlSN2M2ZTcxMmY4RYQ|\"},'__SVGATOR_PLAYER__',window)]]><\/script><\/svg>");
}
...
const Boot = React.forwardRef((props, ref) => {
    const html = getHtml();
    const navigation = useNavigation('');
    useEffect(() => {
        const getInfo = setTimeout(()=>{
            navigation.navigate('Login');
        }, 3000);//this will run after 2 seconds
